...
export const SessionTable: React.FC<SessionTableProps> = ({ results, sessionId }) => {
                ...
                {results
                    ...
                    .map((result, index) => (
                        <TableRow key={index}>
                            ...
                            <TableCell>
                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusStyle(result.status)}`}>
                                    {result.status}
                                </span>
                            </TableCell>
                        </TableRow>
